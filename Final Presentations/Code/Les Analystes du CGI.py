...
plt.show()# Délimitation des années de début et de fin
annee_debut = 1979
annee_fin = 2023
...
article 39 0.05027932960893855In [?]: df['Art'] = df['Art'].str.lower()
        df = df[df['version'] == 1] # On se concentre sur 2023
...
In [?]:  import networkx as nx
    ...
    ...: 
    ...: plt.axis('off')
    ...: plt.savefig('graphN.png', dpi=300, bbox_inches ='tight')	In [?]:  import networkx as nx
    ...: import matplotlib.pyplot as plt
    ...: 
    ...: # Créer le graphique vide
    ...: G = nx.DiGraph()
